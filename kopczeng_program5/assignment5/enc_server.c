...
* Date: 12/7/2022
* Class: CS 344
* Description: This file works as the encryption server, it will take a message with a pre set key and encrypt it before sending back the encrypted message
*************************************************************/
...
int main(int argc, char *argv[]) {
    ...
    while(1) {
        ...
        case 0:
            ...
            // Make sure the file came from an encryption client
